...
* 🎙️ Voice-enabled AI Experiences
* ⚡ FastAPI-based AI Services
* ☁️ Deploying AI applications on AWS

---

## 🛠️ Tech Stack

`Python` • `FastAPI` • `LangChain` • `LangGraph` • `OpenAI` • `FAISS` • `Docker` • `AWS`
...
### 🎙️ Voice Service Desk Assistant
